    ...
    <main class="container mt-5 mb-auto">
        ...
        <form class="w-full lg:w-1/2 mb-4 block bg-slate-900 border border-slate-500 px-4 py-6" id="myform"
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                <button
                    class="hover:animate-shake col-span-2 md:col-span-1 text-sm sm:text-base block px-6 h-12 uppercase font-semibold tracking-wider bg-teal-400 text-slate-900 border border-teal-400 shadow-[5.3px_4px_0px_-.6px_rgba(0,0,0,0.3)] shadow-slate-200/100"
